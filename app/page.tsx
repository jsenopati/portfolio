    ...
    <div className="win7">
      <div className="desktop">
        <div className="desktop-area">
          <div className="mx-auto my-16 flex w-5/6 flex-col items-center rounded-2xl bg-zinc-800 py-16 text-gray-300">
